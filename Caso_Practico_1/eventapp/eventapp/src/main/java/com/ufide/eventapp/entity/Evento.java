...
public class Evento {
    ...
    @Size(max = 120, message = "El nombre del evento no puede exceder los 120 caracteres")
    @Column(nullable = false, length = 120)
    private String nombre;

    @Size(max = 500, message = "La descripción del evento no puede exceder los 500 caracteres")
    @Column(length = 500)
    ...
    @Size(max = 100, message = "El lugar del evento no puede exceder los 100 caracteres")
    @Column(length = 100)
    ...
    /** Tickets ya vendidos. */
    @Positive(message = "Los cupos vendidos deben ser un número positivo")
